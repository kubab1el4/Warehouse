...
session_start();
?>
<?php $title = 'Add Product'; include("top.php");?>
  ...
  <input type="text" id="SKU"  oninput="this.value = this.value.toUpperCase()" required name="SKU"><div class="checker" id="skucheck" style="color: red;">**Please, fill in the SKU.</div><br>
  ...
  <select required id="productType"><div class="checker" id="productcheck" style="color: red;">**Please, choose the product type.</div>
